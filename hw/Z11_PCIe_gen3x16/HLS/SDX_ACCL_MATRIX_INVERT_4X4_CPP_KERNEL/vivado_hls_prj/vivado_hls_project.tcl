...
add_files -tb ../src/tb_matrix_inv_north.cpp -cflags "-O3 -std=c++0x -DVHLS_FLOW -DGPP_ONLY_FLOW $INCLUDES -I$XILINX_OPENCL/runtime/include/1_2 -I$XILINX_OPENCL/Vivado_HLS/include -L$XILINX_OPENCL/runtime/lib/x86_64 -lrt"
