...
#define NUMBER_OF_SDX_BUS_XFERS_PER_INPUT 3
#define NUMBER_OF_SDX_BUS_XFERS_PER_OUTPUT 3
...
//#define NUMBER_OF_DATA_SETS 1
//#define NUMBER_OF_DATA_SETS 1024UL
#define NUMBER_OF_DATA_SETS 1024UL*340UL
