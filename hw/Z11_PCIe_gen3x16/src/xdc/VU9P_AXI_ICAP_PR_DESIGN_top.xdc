...
create_pblock pblock_role_HLS_PR_NORTH
add_cells_to_pblock [get_pblocks pblock_role_HLS_PR_NORTH] [get_cells U_role_NORTH]
resize_pblock [get_pblocks pblock_role_HLS_PR_NORTH] -add {CLOCKREGION_X0Y10:CLOCKREGION_X5Y14 CLOCKREGION_X0Y5:CLOCKREGION_X2Y9 CLOCKREGION_X0Y0:CLOCKREGION_X5Y4}
set_property PARTPIN_SPREADING 3 [get_pblocks pblock_role_HLS_PR_NORTH]
set_property HD.RECONFIGURABLE true [get_cells U_role_NORTH]
